...
pathModel = '/home/alexander/Desktop/CVPR/temp/results/1_temp_dilated/'
...
saveDir = '/home/alexander/Desktop/CVPR/temp/matlab/MaTLAB_dilated/'
...
x = Conv2D(24, (5, 5), padding='same',dilation_rate=(poolSize, poolSize))(input_img)
x = Activation('sigmoid')(x)
#x = MaxPooling2D((poolSize, poolSize), padding='same')(x)
x = Conv2D(24, (5, 5), padding='same',dilation_rate=(poolSize, poolSize))(x)
x = Activation('sigmoid')(x)
#x = MaxPooling2D((poolSize, poolSize), padding='same')(x)
x = Conv2D(24, (5, 5), padding='same',dilation_rate=(poolSize, poolSize))(x)
x = Activation('sigmoid')(x)
