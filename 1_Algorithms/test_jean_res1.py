...
pathModel = '/home/alexander/Desktop/CVPR/temp/results/1_temp_Res1/'
...
saveDir = '/home/alexander/Desktop/CVPR/temp/matlab/MaTLAB_Res1/'
...
x = Conv2D(24, (5, 5), padding='same')(x3)
x4 = Activation('sigmoid')(x)
z = keras.layers.add([x1, x4])
x5 = Conv2D(3, (5, 5), padding='same')(z)
