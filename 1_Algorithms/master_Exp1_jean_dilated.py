...
savePath = '/home/agomez/2_CVPR/1_temp_dilated/'
...
for i in range(len(poolingSize)):
    ...
    command = 'python3 generic_jean_dilated.py '+dataPath+' '+savePath+' '+str(kernelSize[0])+' '+str(poolingSize[i])+' '+str(numKernels[0])
    print(command)
