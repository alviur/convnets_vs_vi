...
illusions = np.expand_dims(cv2.resize(cv2.imread('/home/alexander/Pictures/val_images/z_bird_GT.bmp'),(128,128)),axis=0)
#illusions = np.expand_dims(cv2.resize(cv2.imread('/home/alexander/Desktop/brightness_per/stimulus.png'),(128,128)),axis=0)
#illusions = np.load(pathIllusions+'ilussions.npy')
#illusions = np.load('/home/alexander/Desktop/CVPR/2_Data/sup/128/'+'illusionsSup.npy')/255
