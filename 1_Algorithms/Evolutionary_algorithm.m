...
for gen=1:generations
    ...
    for i=1:population
        ...
        sigma = sigma*exp(normrnd(0,tau));
        mutation = normrnd(0,sigma);
        
        temp1 = (imagesOld(:,:,1,reproductionIndices(i))) + mutation;
        temp1(temp1>1)=1;
        temp1(temp1<0)=0;
        
        temp2 = (imagesOld(:,:,1,reproductionIndices(i)+100)) + mutation;
        temp2(temp2>1)=1;
        temp2(temp2<0)=0;        
        images(:,:,1,i) = temp1;
        images(:,:,1,i+100) = temp2;
