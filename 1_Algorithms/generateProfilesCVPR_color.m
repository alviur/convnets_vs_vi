...
% 
%     posDun = [26,38,64,90,102,64;18,26,22,104,111,22;17,27,22,103,112,22;16,28,22,102,113,22];
% 
%     temp1 = rgb2lab((squeeze(illusions(86,:,:,:))));
%     
%     img1 = temp1(:,:,1);
%     img2 = temp1(:,:,2);
%     img3 = temp1(:,:,3);
...
figure('rend','painters','pos',[10 10 100 100])
plot(chevreulMean3(:,:,1),'Color','r','LineWidth',0.8)
grid on
set(gca,'xtick',[])
 ylim([0 1])
