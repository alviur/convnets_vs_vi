...
pathModel = '/home/alexander/Desktop/CVPR/temp/results/1_temp_Res3/'
...
saveDir = '/home/alexander/Desktop/CVPR/temp/matlab/MaTLAB_Res3/'
...
x0 = Conv2D(24, (5, 5), padding='same')(input_img)
x1 = Activation('sigmoid')(x0)
x = Conv2D(24, (5, 5), padding='same')(x1)
x2 = Activation('sigmoid')(x)
x = Conv2D(24, (5, 5), padding='same')(x2)
x3 = Activation('sigmoid')(x)
z1 = keras.layers.add([x1, x3])
x = Conv2D(24, (5, 5), padding='same')(z1)
x4 = Activation('sigmoid')(x)
z2 = keras.layers.add([x2, x4])
x5 = Conv2D(3, (5, 5), padding='same')(z2)
decoded = Activation('sigmoid')(x5)
